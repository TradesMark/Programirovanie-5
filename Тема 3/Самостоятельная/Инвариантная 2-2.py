...
2.2. Создание геттеров и сеттеров для классов «запись»,
«комментарий» приложения «Гостевая книга». Создание функций
для вывода на печать информации, хранящийся в объектах.
'''
...
if __name__ == "__main__":
    post = Post("Чувак 1", "Типо контент", "СПб")
    post.add_comment(Comment("Чувак 2", "Мир будет мой"))
